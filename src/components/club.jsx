    ...
    return (
        <div className="bg-img bg-cover  w-full p-10   text-white" style={{ backgroundImage: `url(${bgimage})` }}>
            ...
            <div className="card-container flex  my-10 py-10  gap-5 flex-wrap justify-center ">
                <div className="card">
                    <div className="img">
                        <img src={club1} alt="" className='rounded-sm md:w-[300px] w-[300px] object-cover h-[190px]' />

                    </div>

                    <div className=' w-[300px] md:w-[300px] h-[60px] rounded-sm flex  justify-center items-center my-2  overflow-clip  text-md' style={{ backgroundImage: `url(${rectangle13})` }}>WE PLAY </div>
                </div>
                <div className="card">
                    <div className="img">
                        <img src={club2} alt="" className='rounded-sm md:w-[300px] w-[300px] object-cover h-[190px]'  />
                ...
                <div className="card">
                    <div className="img">
                        <img src={club3} alt="" className='rounded-sm md:w-[300px] w-[300px] object-cover h-[190px]'  />
