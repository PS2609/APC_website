  ...
  return (
    <div className="bg-img bg-cover  w-full p-10   text-white" style={{ backgroundImage: `url(${bgimage})`}}>
        ...
        <div className="card  mx-auto md:mx-0">
                ...
                <div  className='w-[300px] md:w-[300px] h-[60px] rounded-sm flex  justify-center items-center my-2  overflow-clip  text-lg'style={{ backgroundImage: `url(${rectangle13})`}}>WE GRIND </div>
            </div>
            <div className="card">
                <div className="img">
