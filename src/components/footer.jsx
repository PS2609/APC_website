...
const footer = ({handleClickMenu}) => {
    return (
        <div className='bg-black px-5 py-2 text-white  '>
            <div className='md:flex w-full justify-between  '>
                <div className="logo font-Monda font-bold">
                    <div className="img w-[120px] mx-auto">
                    <img className='flex justify-center' src="src/images/AP_LOGO.png" alt="" width={100} />
                    </div>
                    <div className="md:text-lg text-md  text-center font-Cutive  my-5">APC IIT PATNA</div>
                </div>
                <div className="social flex-col mx-auto sm:w-[50vw] md:w-auto justify-center items-center ">
                    <div className="social flex justify-center gap-10 sm:justify-normal sm:w-[50vw] md:w-auto  mx-auto items-center my-5">
                        <a href="https://www.instagram.com/apclub.iitp/" target="_blank"><img className="bg-white rounded-full  " src="src/images/instagram.png" alt="" width={50} /></a>
                        <a href="https://www.linkedin.com/company/ap-club-iitp/" target='_blank'><img className="bg-white  md:p-2 rounded-full " src="src/images/linkedin.jpg" alt="" width={50} height={50} /></a>
                        <a href="mailto:Apclub.iitp@gmail.com" target='_blank'><img className="bg-white p-1 md:p-2 rounded-full  " src="src/images/email.jpg" alt="" width={50} /></a>
                        <a href="https://discord.com/invite/ZB5NuxTM" target='_blank'><img className="bg-white p-1 md:p-2 rounded-full " src="src\images\discord.jpg" alt="" width={50} /></a>
                    </div>
