...
import GallaryCardDeck from "./GallaryCardDeck";
...
const Gallary = () => {
    ...
    return (
        <>
            <div className="relative w-full h-full overflow-hidden z-0 m-0 p-0">
                <div className="flex transition-all duration-200" style={{ transform: `translateX(-${(currentPage - 1) * 100}%)` }}>
                    ...
                    <div className="w-full flex-shrink-0">
                        <GallaryBanner title={pages[0].title} bg_url={pages[0].bg_url} subtitle={pages[0].subtitle} img_urls={pages[0].img_urls} page_index={0} buttonOnClick={handleExploreButtonClick} />
                    </div>
                    <div className="w-full flex-shrink-0">
                        <GallaryBanner title={pages[1].title} bg_url={pages[1].bg_url} subtitle={pages[1].subtitle} img_urls={pages[1].img_urls} page_index={1} buttonOnClick={handleExploreButtonClick} />
                    </div>
                    <div className="w-full flex-shrink-0">
                        <GallaryBanner title={pages[2].title} bg_url={pages[2].bg_url} subtitle={pages[2].subtitle} img_urls={pages[2].img_urls} page_index={2} buttonOnClick={handleExploreButtonClick} />
                    </div>
                </div>
                {/* Indicator */}
            ...
            <GallaryCardDeck title={"Gallery"} subtitle={"Images that tell story"} />
            <GallaryCardDeck title={"Astrophotography Gallery"} />
        </>
    );
}
