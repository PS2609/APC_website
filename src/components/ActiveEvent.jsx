...
const ActiveEvent = ({ eventObj, handleCloseButton }) => {
    ...
    return (
        <div className="p-2">
            <div className="relative p-4 rounded-lg bg-transparent">
                <div className="p-2 border-t-[2px] border-l-[4px] border-white">
                    <h1 className="font-bold font-Goldman text-white text-2xl p-2 tracking-wider text-nowrap text-center md:text-left animate-glow">{eventObj.event}</h1>
